      ...
      <div className="p-5 border border-gray-200 rounded-2xl dark:border-gray-800 lg:p-6">
        <div className="flex flex-col items-center gap-6 lg:flex-row lg:items-start lg:justify-between">
          <div className="text-center xl:text-left">
            <div className="relative inline-block p-1 mx-auto mb-4 bg-white rounded-full dark:bg-gray-900 lg:mx-0 lg:mb-5">
              <Image
                width={100}
                height={100}
      ...
      <Dialog open={isOpen} onOpenChange={(open) => !open && closeModal()}>
        <DialogContent className="max-w-[700px] m-4">
          ...
          <form className="flex flex-col">
            ...
            <DialogFooter className="flex items-center gap-3 mt-6 lg:justify-end">
